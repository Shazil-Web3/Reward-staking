  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
          ...
          <div className="container relative z-10">
            <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in">
              <h1 className="text-5xl md:text-7xl font-bold leading-tight">
                Welcome to <span className="gradient-text">Stacking</span>
              </h1>
        ...
        {/* About Stacking Concept */}
        <section className="py-20 bg-muted/30">
          <div className="container">
            <div className="max-w-4xl mx-auto space-y-8">
              <div className="text-center space-y-4">
                <h2 className="text-4xl md:text-5xl font-bold">What is Stacking?</h2>
              ...
              <div className="grid md:grid-cols-3 gap-6 pt-8">
                <Card className="p-6 text-center space-y-4 hover-scale">
                  <div className="mx-auto w-16 h-16 rounded-full gradient-primary flex items-center justify-center">
                    <Lock className="h-8 w-8 text-white" />
                  </div>
                  <h3 className="text-xl font-semibold">Lock Your Tokens</h3>
                  <p className="text-muted-foreground">
                    Purchase a staking package and lock your tokens for 1-5 years
                  </p>
                </Card>
                ...
                <Card className="p-6 text-center space-y-4 hover-scale">
                  ...
                  <p className="text-muted-foreground">
                    Meet referral requirements to qualify for the reward pool
                  </p>
                </Card>
                ...
                <Card className="p-6 text-center space-y-4 hover-scale">
                  ...
                  <p className="text-muted-foreground">
                    After the lock period, withdraw your tokens plus qualified rewards
                  </p>
                </Card>
              </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto space-y-12">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <Card className="p-8 space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <h3 className="text-xl font-semibold">Staking Fees Collected</h3>
                  </div>
                  <p className="text-muted-foreground pl-16">
                    10% fee from every package purchase goes into the reward pool wallet
                  </p>
                </Card>
                ...
                <Card className="p-8 space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <h3 className="text-xl font-semibold">Token Supply Added</h3>
                  </div>
                  <p className="text-muted-foreground pl-16">
                    An equal 10% value in tokens from total supply is added by the project team
                  </p>
                </Card>
                ...
                <Card className="p-8 space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <h3 className="text-xl font-semibold">Total Pool Formed</h3>
                  </div>
                  <p className="text-muted-foreground pl-16">
                    Combined fees and tokens create the total reward pool balance
                  </p>
                </Card>
                ...
                <Card className="p-8 space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <h3 className="text-xl font-semibold">Equal Distribution</h3>
                  </div>
                  <p className="text-muted-foreground pl-16">
                    Qualified users share the reward pool equally based on referral completion
                  </p>
                </Card>
              </div>
              ...
              <Card className="p-8 bg-gradient-to-r from-primary/5 to-secondary/5 border-2">
                ...
                <div className="space-y-3 text-muted-foreground">
                  <p>✓ <strong>15 qualified users</strong> contribute $10 fee each = <strong>$150</strong></p>
                  ...
                  <p className="text-lg font-semibold text-foreground pt-2">
                    = Total Reward Pool: <span className="gradient-text text-2xl">$300</span> distributed equally
                  </p>
                  <p className="text-primary font-semibold">Each qualified user receives: $20</p>
                </div>
              </Card>
            </div>
          </div>
          ...
          <div className="container">
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <Card className="p-8 space-y-4 hover-scale">
                ...
                <Card className="p-8 space-y-4 hover-scale md:col-span-2">
          ...
          <div className="container">
            <div className="max-w-4xl mx-auto text-center space-y-8">
              <h2 className="text-4xl md:text-5xl font-bold">
                Start Your Stacking Journey Today
              </h2>
